...
public class SplashActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//设置有米广告
		AdManager.getInstance(this).init("3993bfd8110ae8b4", "4eea680fe31b3b96", false);
	...
	private void updataVirus() {
		...
		String url = "http://192.168.13.11:8080/virus.json";
...
//				{"md5":"39f20dd2ca2ec9a6d72f08b5808b7b33","desc":"蝗虫病毒赶快卸载"}
				try {
